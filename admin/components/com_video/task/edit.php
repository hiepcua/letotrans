...
<form id="frm_action" name="frm_action" class="form-horizontal" method="post" action=""  enctype="multipart/form-data">
    ...
    <div class="tab-content">
        ...
        <div class="form-group">
        	<div class="col-xs-12">
        		<label>Tóm tắt</label>
        		<textarea name="txt_intro" class="form-control" id="txt_intro" rows="3"><?php echo $row['intro'];?></textarea>
        	</div>
        </div>
        ...
        <div class="form-group">
        	<div class="col-xs-12">
        		...
        		<textarea name="txt_content" class="form-control" id="txt_content"><?php echo $row['content'];?></textarea>
        	</div>
        </div>
	</div>
