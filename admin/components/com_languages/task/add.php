...
<form id="frm_action" name="frm_action" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="txt_name" class="form-control" id="txt_name" placeholder="Tên ngôn ngữ" required>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="txt_iso" class="form-control" id="txt_iso" placeholder="iso">
            </div>
        </div>
        <div class="clearfix"></div>
    </div>
