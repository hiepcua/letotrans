...
$sql = "SELECT * FROM `tbl_languages` WHERE id=".$id;
$objmysql->Query($sql);
...
<div id="path">
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo ROOTHOST_ADMIN.COMS;?>">Danh sách ngôn ngữ</a></li>
        <li class="active">Thêm mới ngôn ngữ</li>
    </ol>
</div>

<div class="com_header color">
    <h1>Thêm mới ngôn ngữ</h1>
...
<form id="frm_action" name="frm_action" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        <div class='form-group'>
            <label class="col-sm-2 form-control-label"><strong>Hình ảnh<small class="cred"> (*)</small></strong></label>
            <div class="col-sm-10">
                <div class="row">
                    <div class="col-sm-10">
                        <input id="txtthumb" name="txtthumb" type="text" id="file-thumb" size="45" class='form-control' value="<?php echo $row['image']; ?>" placeholder='Link ảnh' />
                    </div>
                    <div class="col-sm-2">
        ...
        <div class="form-group">
            <label for="" class="col-sm-2 form-control-label">Tên<small class="cred"> (*)</small></label>
            <div class="col-sm-10">
                <input type="text" name="txt_name" class="form-control" id="txt_name" value="<?php echo $row['name']; ?>" placeholder="Tên ngôn ngữ" required>
            </div>
            <div class="clearfix"></div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 form-control-label">Iso</label>
            <div class="col-sm-10">
                <input type="text" name="txt_iso" class="form-control" value="<?php echo $row['iso']; ?>" id="txt_iso" placeholder="iso">
            </div>
        </div>
        <div class="clearfix"></div>
    </div>
