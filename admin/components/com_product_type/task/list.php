...
$sql="SELECT COUNT(*) AS count FROM tbl_product_type WHERE 1=1 ".$strwhere;
$objmysql->Query($sql);
...
<div class="table-responsive">
	<table class="table table-bordered">
        ...
        $leng = MAX_ROWS;
        $sql = "SELECT * FROM tbl_product_type WHERE 1 = 1 ".$strwhere." ORDER BY `order` ASC LIMIT ".$star.", ".$leng;
