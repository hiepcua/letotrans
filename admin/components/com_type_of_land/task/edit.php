...
$sql = "SELECT * FROM tbl_type_of_land WHERE id = ".$id;
$objmysql->Query($sql);
...
<form id="frm_action" name="frm_action" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
    <input type="hidden" name="txtid" value="<?php echo $rows['id'];?>">
    <div class="tab-content">
        <div class="tab-pane fade active in" id="info">
            <div class="form-group">
                <div class="col-md-6">
                    <label>Tên loại hình đất<small class="cred"> (*)</small><span id="txt_name_err" class="mes-error"></span></label>
                    <input type="text" name="txt_name" class="form-control" placeholder="Tên loại hình đất" value="<?php echo $rows['title'];?>" required>
                </div>
            </div>
