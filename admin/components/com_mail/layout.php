...
<div class="body">
	<div class='col-md-2'>
		<div class='row body_col_left bleft bright'>
			<div class="com_header color">
				<i class="fa fa-envelope" aria-hidden="true"></i> Hòm thư
			</div>
			<input type='hidden' id='guser_selected' value=''/>
			<div class='user_group_list'>
				<ul class='menu'>
					<li><a href="<?php echo ROOTHOST_ADMIN;?>mail" onclick="user_group_select(this);" dataid="1" <?php if($task=='' || $task=='list') echo "class='checked'";?>>
						<i class="fa fa-inbox" aria-hidden="true"></i> Hộp thư đến</a></li>
					<li><a href="<?php echo ROOTHOST_ADMIN;?>mail/outbox" onclick="user_group_select(this);" dataid="2" <?php if($task=='outbox') echo "class='checked'";?>>
						<i class="fa fa-inbox" aria-hidden="true"></i> Thư đã gửi</a></li>
					<li><a href="<?php echo ROOTHOST_ADMIN;?>mail/new" onclick="user_group_select(this);" dataid="3" <?php if($task=='new') echo "class='checked'";?>>
						<i class="fa fa-envelope-o" aria-hidden="true"></i> Soạn thư mới</a></li>
					<li><a href="<?php echo ROOTHOST_ADMIN;?>mail/config" onclick="user_group_select(this);" dataid="4" <?php if($task=='config') echo "class='checked'";?>>
						<i class="fa fa-cog" aria-hidden="true"></i> Cấu hình mail</a></li>
				</ul>
			</div>
	...
	<div class='col-md-10 body_col_right'>
		<?php
