...
$sql = "SELECT * FROM tbl_co_operate WHERE id = ".$id;
$objmysql->Query($sql);
...
<div id="path">
    <ol class="breadcrumb">
        ...
        <li class="active">Cập nhật đăng ký hợp tác </li>
    </ol>
</div>

<div class="com_header color">
    <h1>Cập nhật đăng ký hợp tác </h1>
            ...
            <div class="tab-pane fade active in" id="info">
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <input type="text" name="txt_phone" class="form-control" value="<?php echo $row['phone']; ?>" placeholder="Số điện thoại">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6 col-sm-6">
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <input type="text" name="txt_company" class="form-control" value="<?php echo $row['company']; ?>" placeholder="Tên cơ quan/ tổ chức">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-6 col-sm-6">
