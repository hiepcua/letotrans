...
$sql_count = "SELECT COUNT(*) AS count FROM tbl_co_operate WHERE 1=1 ".$strwhere;
...
<div id="path">
    <ol class="breadcrumb">
        ...
        <li class="active">Danh sách đăng ký hợp tác</li>
    </ol>
</div>
...
<div class="table-responsive">
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM tbl_co_operate WHERE 1=1 $strwhere ORDER BY `id` DESC LIMIT $star,".MAX_ROWS_ADMIN;
            $objmysql->Query($sql);
            $i = 0;
