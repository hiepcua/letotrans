<?php
$obj_cata = new CLS_CATE_NEWS();
$obj_cata->getList(' AND `cat_id` = '.$cat_id);
if($obj_cata->Num_rows()>0)
{
	$result_cate = $obj_cata->Fetch_Assoc();
	$album_id_banner = (int)$result_cate['album_id'];
