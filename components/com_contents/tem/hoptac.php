	...
	<div class="article">
		<div class="container">
			...
			<div class="page-content">
				...
				<div class="block-co-operate">
					<h3 class="title">Đăng ký hợp tác</h3>
					<form method="post" action="<?php echo ROOTHOST; ?>dang-ky-hop-tac">
						<div class="row">
							<div class="from-group">
								...
								<div class="col-md-6 col-sm-6">
									<input type="text" name="txt_company" class="form-control" placeholder="Đơn vị công tác" required>
								</div>
								<div class="col-md-6 col-sm-6">
									<input type="text" name="txt_phone" class="form-control" placeholder="Số điện thoại" required>
								</div>
								<div class="col-md-6 col-sm-6">
						...
						<div class="text-center">
							<input type="submit" name="save-co-operate" class="btn btn-basic" value="Đăng ký hợp tác">
						</div>
					</form>
				</div>
