...
$keywork = ($_GET['k']) ? addslashes(trim($_GET['k'])) : "";
$cat_id = '';
?>
			...
			<div class="row">
				<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
					<div class="wrapper-right">
						<div class="top">
							<h1 class="main-title"><span>Tìm kiếm</span></h1>
						</div>
						<div class="row">
							<?php
							$cur_page=isset($_GET['page'])? $_GET['page']: '1';
							$cur_page=isset($_POST['txtCurnpage'])? $_POST['txtCurnpage']: '1';
							$strWhere = " AND title LIKE '%".$keywork."%'";
							...
							if($total_rows>0){
								...
								$objcon->getList($strWhere." ORDER BY cdate DESC"," LIMIT $start,".MAX_ROWS);
								$i=0;
